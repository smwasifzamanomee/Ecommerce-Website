...
const Products = ({ props, handleAddToCart }) => {
    const { name, price, img, category, seller, stock } = props
    return (
        <div>
            <section>
                ...
                <div className="space-y-8 lg:divide-y lg:divide-gray-100">
                    <div className="pt-8 sm:flex lg:items-end group">
                        ...
                        <div>
                            ...
                            <button className="mt-2 bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-md focus:outline-none" onClick={() => handleAddToCart(props)}>Add to cart</button>
                        </div>
                    </div>
